	...
	<c:if test="${not empty editCustomer}">
			<form action="updateCustomer" method="POST">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="customerSSN" name="customerSSN" placeholder="Enter SSN" value='${editCustomer.userSSN}' readonly>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="customerAcc" name="customerAcc" placeholder="XXX-XX-XXXX" value='${editCustomer.accNum}' readonly>
				</div>

				<div class="form-group">
					<label for="customerAccCreate">Account Creation Date</label>
					<input type="text" class="form-control" id="customerAccCreate" name="customerAccCreate" value='${editCustomer.accCreateDate}' required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="customerLastActive" name="customerLastActive" value='${editCustomer.dateLastActive}' required>
				</div>
